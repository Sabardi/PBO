...
use penjumlahan as GlobalPenjumlahan;

if($_POST["oprasi"]=="penjumlahan"){
    $penjumlahan = new penjumlahan();
    // echo $penjumlahan->__construct("penjumlahan");
    // echo $penjumlahan.$judul = "Penjumlahan"; 
    $penjumlahan->hasil();
...
class penjumlahan {
    ...
    var $angka2;
    var $hasil;
    var $judul = "penjumlahan";

    function __construct(){
        // $this->judul = $judul;
        // return $this->judul;
        echo "ini penjumlahan <br>";
    }
